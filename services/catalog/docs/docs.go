            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpsertEditorialRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/products": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Filter to sale items only",
                        "name": "on_sale",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.ProductListResult"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
    ...
    "definitions": {
        ...
        "models.Product": {
            ...
            "properties": {
                ...
                "category": {
                    "description": "beauty|apparel|home|shoes|accessories|tech|wellness|toys",
                    "type": "string"
                },
                "colors": {
                    "type": "array",
                ...
                "recipients": {
                    "description": "her|him|kids|teens|pets",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
