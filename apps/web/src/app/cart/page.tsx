    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-screen-lg mx-auto px-4 sm:px-6 py-10">
        ...
        <nav className="flex items-center gap-1.5 mb-8 text-[11px] tracking-wide">
          ...
          <span className="text-nordstrom-gray-500">Shopping Bag</span>
        </nav>

        <h1 className="text-2xl font-light tracking-tight text-nordstrom-black mb-8">
          Shopping Bag
          {!loading && !isEmpty && (
        ...
        {checkedOut ? (
          <div className="text-center py-20 space-y-4">
            ...
            <p className="text-lg font-light text-nordstrom-black">Order placed — thank you!</p>
            <p className="text-sm text-nordstrom-gray-500">You'll receive a confirmation shortly.</p>
            <Link href="/gifts" className="inline-block mt-4 text-xs tracking-widest uppercase underline text-nordstrom-black hover:text-nordstrom-gray-700">
              Continue Shopping
            </Link>
          </div>
        ) : loading ? (
            ...
            {[1, 2].map((i) => (
              <div key={i} className="animate-pulse flex gap-5 py-6 border-b border-nordstrom-gray-100">
                ...
                <div className="flex-1 space-y-2 pt-1">
                  ...
                  <div className="h-3 bg-nordstrom-gray-100 w-1/5 mt-4" />
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-10">
            {/* Item list */}
            <div className="flex-1 divide-y divide-nordstrom-gray-100">
              {items.map((item) => (
                <div key={item.id} className="flex gap-5 py-6">
                  ...
                  <div className="flex-1 min-w-0 flex flex-col gap-1">
                    ...
                    <Link
                      href={`/product?style_id=${item.style_id}`}
            ...
            <div className="lg:w-80 shrink-0">
              <div className="border border-nordstrom-gray-200 p-6 space-y-4 sticky top-24">
                ...
                <div className="pt-2 space-y-1.5 text-[11px] text-nordstrom-gray-500">
